...
public class Rule
{
    ...
    public virtual HashSet<string> GetGroups()
    {
        return groups;
    }

    public virtual bool MatchId(string identifier)
    {
    ...
    public virtual void AddGroup(string groupId)
    {
        if (groups == null)
    ...
    public virtual void RemoveGroup(string groupId)
    {
        if (groups != null)
