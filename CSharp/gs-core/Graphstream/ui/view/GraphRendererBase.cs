...
public abstract class GraphRendererBase<S, G> : GraphRenderer<S, G>, StyleGroupListener
{
    protected GraphicGraph graph;
    protected Selection selection = null;
    protected S renderingSurface;
    public virtual void Open(GraphicGraph graph, S renderingSurface)
    {
        if (this.graph != null)
    ...
    public virtual S GetRenderingSurface()
    {
        return renderingSurface;
    }

    public virtual void BeginSelectionAt(double x1, double y1)
    {
        if (selection == null)
    ...
    public virtual void SelectionGrowsAt(double x, double y)
    {
        selection.x2 = x;
        selection.y2 = y;
    }

    public virtual void EndSelectionAt(double x2, double y2)
    {
        selection = null;
    }
}
