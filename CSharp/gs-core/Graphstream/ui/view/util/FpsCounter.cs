...
public class FpsCounter
{
    ...
    {
        return (1000000000 / time);
    }

    public virtual double GetLastFrameTimeInSeconds()
    {
        return (time / 1000000000);
    }

    public virtual int GetAverageMeasureCount()
    {
        return count;
    }

    public virtual double GetAverageFramesPerSecond()
    {
        return (1000000000 / (avgTime / count));
    }

    public virtual double GetAverageFrameTimeInSeconds()
    {
        return ((avgTime / count) * 1000000000);
    }

    public virtual void ResetAverages()
    {
        count = 0;
        avgTime = 0;
    }
