...
public class SpringBox : BarnesHutLayout
{
    protected double k = 1F;
    protected double K1 = 0.06F;
    protected double K2 = 0.024F;
    public SpringBox() : this(false)
    {
    }

    public SpringBox(bool is3D) : this(is3D, new Random(System.CurrentTimeMillis()))
    {
    }

    public SpringBox(bool is3D, Random randomNumberGenerator) : base(is3D, randomNumberGenerator)
    {
        SetQuality(0.1);
    }
