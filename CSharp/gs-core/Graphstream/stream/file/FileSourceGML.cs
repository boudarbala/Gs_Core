using Java.Io;
using Gs_Core.Graphstream.Stream.File.Gml;
...
public class FileSourceGML : FileSourceParser
{
    ...
    {
        public AnonymousParserFactory(FileSourceGML parent)
        {
            this.parent = parent;
        }

        private readonly FileSourceGML parent;
        public Parser NewParser(Reader reader)
        {
            return new GMLParser(this, reader);
        }
    }
}
