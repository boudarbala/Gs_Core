using Java.Io;
using Gs_Core.Graphstream.Stream.File.Tlp;
...
public class FileSourceTLP : FileSourceParser
{
    ...
    {
        public AnonymousParserFactory(FileSourceTLP parent)
        {
            this.parent = parent;
        }

        private readonly FileSourceTLP parent;
        public Parser NewParser(Reader reader)
        {
            return new TLPParser(this, reader);
        }
    }
}
